...
local EFFECT_QUALITY = 16
local EFFECT_IQUALITY = 32
...
local function DoSecondaryParticlesAt(emitter, pos)
	for i=1, 2 do
		...
		particle:SetVelocity(Vector(math.Rand(-0.8, 0.8), math.Rand(-0.8, 0.8), math.Rand(0, 1)):GetNormal() * math.Rand(16, 64))
...
function EFFECT:Init(data)
	...
	emitter:SetNearClip(32, 48)
		for i=1, math.max(8, EFFECT_QUALITY * 16) do
			...
			particle:SetVelocity(VectorRand():GetNormal() * math.Rand(400, 600) + Vector(0,0,math.Rand(500, 700)))
		...
		for i=1, math.max(2, EFFECT_QUALITY * 3) do
			...
			particle:SetVelocity(Vector(math.Rand(-1, 1), math.Rand(-1, 1), math.Rand(0, 0.5)):GetNormal() * math.Rand(32, 128))
...
function EFFECT:Render()
	...
	ent:SetColor(Color(255, 200, 25, (38 - siz) * 5.3125))
