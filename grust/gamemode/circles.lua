...
do
	...
	function CIRCLE:Translate(x, y)
		...
		if self.m_Type == CIRCLE_OUTLINED and self.m_ChildCircle then self.m_ChildCircle:Translate(x, y) end
	end
end
...
do
	...
	function CIRCLE:Scale(scale)
		...
		if self.m_Type == CIRCLE_OUTLINED and self.m_ChildCircle then self.m_ChildCircle:Scale(scale) end
	end
end
...
do
	...
	function CIRCLE:Rotate(rotation)
		...
		if self.m_Type == CIRCLE_OUTLINED and self.m_ChildCircle then self.m_ChildCircle:Rotate(rotation) end
	end
end
...
do
	local function AccessorFunc(name, default, dirty, callback)
		...
		CIRCLE["Set" .. name] = function(self, value)
			if default ~= nil and value == nil then value = default end
	...
	local function OffsetVerticesX(circle, old, new)
		...
		if circle.m_Type == CIRCLE_OUTLINED and circle.m_ChildCircle then OffsetVerticesX(circle.m_ChildCircle, old, new) end
		return new
	end
	...
	local function OffsetVerticesY(circle, old, new)
		...
		if circle.m_Type == CIRCLE_OUTLINED and circle.m_ChildCircle then OffsetVerticesY(circle.m_ChildCircle, old, new) end
		return new
	end
	...
	local function UpdateRotation(circle, old, new)
		...
		RotateVertices(vertices, x, y, rotation, rotate_uv)
		if circle.m_Type == CIRCLE_OUTLINED and circle.m_ChildCircle then UpdateRotation(circle.m_ChildCircle, old, new) end
		return new
	end
